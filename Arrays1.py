...
print('Both arrays do not have the same row and column length - Incompatible Array Shapes (4x3 vs 3x4)')
print()
...
## this worked! why?
print('Both arrays have the same row and column length')
print()
